...
//		assertThat(httpClientErrorException.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
		ResponseEntity<Beneficiary> newBeneficiaryResponse = restTemplate.getForEntity(newBeneficiaryLocation,
				Beneficiary.class);
		assertThat(newBeneficiaryResponse.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
